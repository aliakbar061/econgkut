      ...
      <div className="App">
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/admin" element={user?.role === 'admin' || (user?.role === 'staff' && ['SDM', 'IT', 'SDM & IT', 'Operasional', 'Pengolahan', 'Operasional & Pengolahan'].includes(user?.division)) ? <AdminDashboard /> : <Navigate to="/dashboard" />} />
