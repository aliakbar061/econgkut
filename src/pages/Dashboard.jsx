...
import { Truck, Plus, History, LogOut, Calendar, Package, User, LayoutDashboard, ClipboardCheck, Users } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-green-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          {/* Portal Absensi: tampil untuk staff dan admin */}
          {(user?.role === 'staff' || user?.role === 'admin') && (
            ...
            >
              ...
              <p className="text-gray-600 mb-4">Catat kehadiran harian dengan kamera & lokasi</p>
          ...
          {/* Admin Dashboard: tampil hanya untuk admin */}
          {user?.role === 'admin' && (
            <div
