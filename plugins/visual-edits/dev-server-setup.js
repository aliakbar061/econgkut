...
<<<<<<< HEAD
            execSync(`git -c user.name="visual-edit" -c user.email="support@econgkut" add "${targetFile}"`);
            execSync(`git -c user.name="visual-edit" -c user.email="support@econgkut" commit -m "visual_edit_${timestamp}"`);
=======
